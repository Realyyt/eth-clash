  ...
  return (
    <section id="game-overview" className="py-20 relative overflow-hidden ">
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
         Transform your social life into an exciting adventure! Imagine earning real ETH just by been at the party. It&apos;s not just networking &ndash; it&apos;s your new favorite game!</motion.p>
        <motion.div 
